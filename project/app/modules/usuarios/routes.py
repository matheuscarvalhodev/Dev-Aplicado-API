...
@router.get("/", response_model=List[Usuario], tags=["Usuário"], summary=["Lista todos os usuários"])
...
@router.get("/{usuario_id}", response_model=Usuario, tags=["Usuário"], summary=["Lista o usuáro a partir do id"])
...
@router.post("/", response_model=Usuario, tags=["Usuário"], summary=["Cria um novo usuário"])
...
@router.post("/{usuario_id}", response_model=Usuario, tags=["Usuário"], summary=["Atualiza as informações do usuário"])
...
@router.delete("/{usuario_id}", tags=["Usuário"], summary=["Deleta o usuário"])
